...
[environment,imc, shell_imc] = createEnvironmentAndIMCStructs(env,geom,material,sim_params);
...
for timeStep = 1:Nsteps
    ...
    [softRobot, stretch_springs, bend_twist_springs, hinge_springs] = ...
        timeStepper(softRobot, stretch_springs, bend_twist_springs, hinge_springs, triangle_springs, tau_0,environment,imc, shell_imc, sim_params);
