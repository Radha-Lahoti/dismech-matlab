function [Fc, Jc] = computeShellContact_trial(q,  C, constraint_types, delta, contact_len, scale, k_c, n_dof, use_hess)
% % Inputs
...
for i = 1:num_inputs
    [dist, ~, tri_combo_input, combo_nodes_updated] = triangleContactType(q, C(i,:), scale);
%     dist
