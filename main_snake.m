...
%% save kappa_bar 
% kappa_values = zeros(n_bend_twist, 1);
% 
% % Collect the values
% for i = 1:n_bend_twist
%     kappa_values(i) = bend_twist_springs(i).kappaBar(2);
% end
% 
% % Write to an Excel file
% filename = 'kappa_bar2.xls';
% writematrix(kappa_values, filename);


%% load kappa_bar
load('experiments/snake/kappa_bar.mat');  % This loads the variable 'k_bar' into the workspace
...
for timeStep = 1:Nsteps
    ...
    %% actuate kappa bar
    bend_twist_springs = actuatekappa(bend_twist_springs, k_bar(:,:, timeStep));
